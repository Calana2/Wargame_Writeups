...
En este es hasta más fácil, tenemos un gadget que rellena los registros $s0-$s5 y otro que rellena $a1 y $a2 con $s4 y $s5 respectivamente, salta a $r9 y si $a1 != $a2, carga $s3 en $a0 y vuelve a saltar a $r9.
